...
import { defaultLocale, isLocale, type Locale } from "@/app/lib/i18n";
import { whatsappUrl, whatsappAriaLabel } from "@/app/lib/whatsapp";
import { track } from "@/app/lib/analytics";

function currentLocale(pathname: string | null): Locale {
...
export function WhatsAppFab() {
  ...
  const label = whatsappAriaLabel(locale);
