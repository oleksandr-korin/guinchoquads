...
//
// NOTE: reviewed=false. First-pass translation, needs a native speaker
// review before we flip the switch. Pages built against this dictionary
// stay noindex/nofollow and are excluded from the sitemap until then.
