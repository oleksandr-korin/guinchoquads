// Portuguese (pt-PT) dictionary.
//
// NOTE: reviewed=false. This is a first-pass translation that needs a
// native-speaker review (Arlindo). Pages built against this dictionary
// stay noindex/nofollow and are excluded from the sitemap until the flag
// flips to true.
